...
class ElementLevelInformationType
{
    ...
    /**
     * @property \GoetasWebservices\Client\UPS\Error\ElementIdentifierType[] $elementIdentifier
     */
     ...
     *
     * @return self
     * @param \GoetasWebservices\Client\UPS\Error\ElementIdentifierType $elementIdentifier
     */
    public function addToElementIdentifier(\GoetasWebservices\Client\UPS\Error\ElementIdentifierType $elementIdentifier)
    {
     ...
     *
     * @return \GoetasWebservices\Client\UPS\Error\ElementIdentifierType[]
     */
